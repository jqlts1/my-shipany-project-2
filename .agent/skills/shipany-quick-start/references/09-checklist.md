...
- `src/config/locale/messages/*/pages/blog.json` (blog page metadata)
- `src/config/locale/messages/*/pages/updates.json` (changelog page metadata)
...
- `content/logs/*.mdx` (changelog/update log entries)

## Conditional (if user provides content or requests cleanup)

- `content/posts/*.mdx` (blog articles — update or delete based on relevance)
